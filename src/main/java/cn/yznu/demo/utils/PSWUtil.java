...
public class PSWUtil {
	...
	public static void main(String[] args) {
		...
		try {
			byte[] salt = PSWUtil.getStaticSalt();
			String ciphertext = PSWUtil.encrypt(str, password, salt);
			System.out.println("密文:" + ciphertext);
			String plaintext = PSWUtil.decrypt(ciphertext, password, salt);
