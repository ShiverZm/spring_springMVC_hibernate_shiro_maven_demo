...
<link
	href='http://fonts.googleapis.com/css?family=Fira+Sans:400,300,300italic,400italic,500,500italic,700,700italic'
	rel='stylesheet' type='text/css'>
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-2">
								<ul class="nav navbar-nav navbar-right">
									<li class="hidden-xs hidden-sm"><a href="contact.html">Hi!欢迎您</a></li>
									<li class="hidden-xs hidden-sm"><a href="single-book.html">购物车</a></li>
									<li class="hidden-xs hidden-sm"><a href="page/login.html">登录/注册</a></li>
									<li class="icon icon-small hidden-xs"><a
										data-toggle="modal" data-target="#modal-login-big" href="#"><i
									...
									<form role="form" class="inner-top-50">
										<div class="form-group">
											<label for="exampleInputEmail1" class="sr-only">Email
												...
												id="exampleInputEmail1" placeholder="Hezy Theme">
										</div>
										<div class="form-group">
							...
							<div
								...
								<div class="media free-delivery hidden-xs ">
									<span class="media-left"><img
										src="static/images/delivery-icon.png" height="48" width="48"
										alt=""></span>
									...
									<li class="dropdown"><a class="menu-toggle-right clearfix"
										href="/.menu-toggle-right"> <span
											class="pull-right cart-right-block"> <img
												src="static/images/cart-icon.png" alt="" width="46"
												height="39" />
										</span>
				...
				<div class="content">
														...
														<div class="book-shelf">
															<div class="book-cover slider-book-cover bk-cover m-t-20">
																<img class="img-responsive" alt=""
																	...
																	data-echo="static/images/slider-images/01.png">
																<div class="fade"></div>
															</div>
															<!-- /.book-cover -->
														</div>
					...
					<div class="container">
									...
									<div class="wide-banner cnt-strip">
										<div class="image">
											<img class="img-responsive"
												src="static/images/wide-banners/banner1.png" alt="">
										</div>
						...
						<div class="divider inner-vs">
							<img class="img-responsive" src="static/images/shadow.png" alt="">
						</div>
						<!-- /.divider -->
												...
												<div class="book">
													<a href="single-book.html">
														<div class="book-cover">
															<img width="140" height="212" alt=""
																src="static/images/blank.gif"
																data-echo="static/images/book-covers/01.jpg">
															<div class="tag">
																<span>sale</span>
															</div>
														</div>
													...
													<div class="book-details clearfix">
														<div class="book-description">
															<h3 class="book-title">
																<a href="single-book.html">The Brief Wondrous Life
																	of Oscar Wao</a>
															</h3>
											...
											<div class="col-md-3 col-sm-6">
												<div class="book">
													<a href="single-book.html"><div class="book-cover">
															<img width="140" height="212" alt=""
																src="static/images/blank.gif"
																data-echo="static/images/book-covers/02.jpg">
														</div></a>
													<div class="book-details clearfix">
														<div class="book-description">
															<h3 class="book-title">
											...
											<div class="col-md-3 col-sm-6">
												<div class="book">
													<a href="single-book.html"><div class="book-cover">
															<img width="140" height="212" alt=""
																src="static/images/blank.gif"
																data-echo="static/images/book-covers/03.jpg">
														</div></a>
													<div class="book-details clearfix">
														<div class="book-description">
															<h3 class="book-title">
											...
											<div class="col-md-3 col-sm-6">
												<div class="book">
													<a href="single-book.html"><div class="book-cover">
															<img width="140" height="212" alt=""
																src="static/images/blank.gif"
																data-echo="static/images/book-covers/04.jpg">
														</div></a>
													<div class="book-details clearfix">
														<div class="book-description">
															<h3 class="book-title">
											...
											<div class="col-md-3 col-sm-6">
												<div class="book">
													<a href="single-book.html"><div class="book-cover">
															<img width="140" height="212" alt=""
																src="static/images/blank.gif"
																data-echo="static/images/book-covers/05.jpg">
														</div></a>
													<div class="book-details clearfix">
														<div class="book-description">
															<h3 class="book-title">
														...
														<div class="col-md-10 author-block center-block">
															<div class="row">
																<div class="col-md-4 col-xs-5">
																	<div class='image'>
																		<img class="img-responsive"
																			src="static/images/testimonials/author1.png" alt="">
																	</div>
																	<!-- /.image -->
																</div>
																<!-- /.col -->
																<div class="col-md-8 col-xs-7">
																	<h5 class="author-name outer-top-xs">Philip
																		Anthony Hopkins</h5>
																	<span>Coca-Cola</span>
																</div>
																<!-- /.col -->
														...
														<div class="col-md-10 author-block center-block">
															<div class="row">
																<div class="col-md-4 col-xs-5">
																	<div class='image'>
																		<img class="img-responsive"
																			src="static/images/testimonials/author2.png" alt="">
																	</div>
																	<!-- /.image -->
																</div>
																<!-- /.col -->
										...
										<div class="col-md-10 col-sm-10 center-block clearfix">
											<div class="col-md-3 col-sm-4">
												<div class="book-cover bk-cover product-book-cover">
													<img class="img-responsive" alt=""
														src="static/images/blank.gif"
														data-echo="static/images/book-covers/06.jpg" width="182"
														height="273">
													<div class="fade"></div>
												</div>
												<!-- /.book-cover -->
											...
											<div class="col-md-3 col-sm-4 hidden-xs">
												<div class="book-cover bk-cover product-book-cover">
													<img class="img-responsive" alt=""
														src="static/images/blank.gif"
														data-echo="static/images/book-covers/07.jpg" width="182"
														height="273">
													<div class="fade"></div>
												</div>
												<!-- /.book-cover -->
											...
											<div class="col-md-3 col-sm-4 hidden-xs">
												<div class="book-cover bk-cover product-book-cover">
													<img class="img-responsive" alt=""
														src="static/images/blank.gif"
														data-echo="static/images/book-covers/08.jpg" width="182"
														height="273">
													<div class="fade"></div>
												</div>
												<!-- /.book-cover -->
											...
											<div class="col-md-3 hidden-sm hidden-xs">
												<div class="book-cover bk-cover product-book-cover">
													<img class="img-responsive" alt=""
														src="static/images/blank.gif"
														data-echo="static/images/book-covers/09.jpg" width="182"
														height="273">
													<div class="fade"></div>
												</div>
												<!-- /.book-cover -->
								...
								<div class="row">
									<div class="col-md-10 center-block marketing-block">
										...
										<div class="divider inner-xs">
											<img class="img-responsive" src="static/images/shadow.png"
												alt="">
										</div>
										<!-- /.divider -->
										...
										<div class="col-md-4 col-sm-6">
											<div class="banners">
												<div class="banner green-banner">
													<div class='image'>
														<img class="img-responsive" src="static/images/blank.gif"
															data-echo="static/images/product1.jpg" alt="">
													</div>
													<!-- /.image -->
													<div class='caption'>
										...
										<div class="col-md-4 col-sm-6 hidden-xs">
											<div class="banners">
												<div class="banner black-banner">
													<div class='image'>
														<img class="img-responsive" src="static/images/blank.gif"
															data-echo="static/images/product2.jpg" alt="">
													</div>
													<!-- /.image -->
													<div class='caption'>
										...
										<div class="col-md-4 hidden-xs hidden-sm">
											<div class="banners">
												<div class="banner orange-banner">
													<div class='image'>
														<img class="img-responsive" src="static/images/blank.gif"
															data-echo="static/images/product3.jpg" alt="">
													</div>
													<!-- /.image -->
													<div class='caption'>
								...
								<div class="row">
									<div class="col-md-6 col-sm-6">
										<div class="row">
											<div class="col-md-5 col-sm-5 blog-image">
												<a href="#"><img src="static/images/blank.gif"
													data-echo="static/images/blog/1.jpg" alt="" class="blog1"
													width="199" height="177"></a>
											</div>
											<div class="col-md-7 col-sm-7 blog-info">
												<h4 class="blog-heading">
													<a href="#">Cras dapibus. Vivamus elementum semper
														nisi. Aenean vulputate eleifend</a>
												</h4>
									...
									<div class="col-md-6 col-sm-6">
										<div class="row">
											<div class="col-md-5 col-sm-5 blog-image">
												<a href="#"><img src="static/images/blank.gif"
													data-echo="static/images/blog/2.jpg" alt="" class="blog2"
													width="199" height="177"></a>
											</div>
											<div class="col-md-7 col-sm-7 blog-info">
												<h4 class="blog-heading">
									...
									<div class="footer-module-body m-t-20 clearfix">
										<p>
											<span class="pull-left"><img
												src="static/images/footer-logo.png" alt="" width="75"
								...
								<div class="footer-module">
									...
									<div class="footer-module-body clearfix">
										...
										<div class="inner-top-xs">
											...
											<form class="searchform" action="http://inspectelement.com/"
												method="get">
												<input class="s" type="text" placeholder="Email Address"
													name="s" value=""> <input class="searchsubmit"
							...
							<div class="col-md-12">
								<div class="pull-left">
									<ul class="payment-list list-unstyled">
										<li><a href="#"><img
												src="static/images/payments/1.png" class="img-responsive"
												height="22" alt=""></a></li>

									</ul>
								</div>
								<p class="copyright-footer pull-right">
									&copy; 2014 Bookshop. All rights reserved. Made with love by <a
										href="#">Heztheme</a>
								</p>
							</div>
						</div>
